...
from .disk_scan_tab import DiskScanTab
...
class App(tk.Tk):
    ...
    def __init__(self, config: Optional[dict] = None):
        ...
        self.disk_scan_tab = DiskScanTab(self.notebook, self.config, self._theme, self._set_status)
        ...
        self.notebook.add(self.disk_scan_tab, text="  磁盘扫描  ")
